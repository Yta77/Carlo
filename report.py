...
data = pd.read_excel("C:\\Users\\carlo\\OneDrive\\Desktop\\Trading & Risk - Carlo\\Dash\\Dati\\Statement3.xlsx")

df = data#.groupby(['Commodity'], as_index=False)

#df2 = data.groupby(['mese'],as_index=False)
...
def update_graph(selected_commodity,selected_commodity2,selected_activity):
    ...
    #filtered_product = data[(data['Activity'] == selected_activity)]
